                            ...
                            <div class="card-body p-0 pb-3 text-center">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0">投稿ID</th>
                                        <th scope="col" class="border-0">投稿时间</th>
                                        <th scope="col" class="border-0">科目</th>
                                        <th scope="col" class="border-0">应用轮次</th>
                                        <th scope="col" class="border-0">应用章节</th>
                                        <th scope="col" class="border-0">适用省份</th>
                                        <th scope="col" class="border-0">教材版本</th>
                                        <th scope="col" class="border-0">文件</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <c:forEach items="${userList}" var="user" varStatus="status">
                                        <tr>
                                            ...
                                            <td>${user.date}</td>
                                            <td>${user.subject}</td>
                                            <td>${user.application_round}</td>
                                            <td>${user.application_chapter}</td>
                                            <td>${user.province}</td>
                                            <td>${user.textbook_version}</td>
                                            <td>${user.word_path}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
