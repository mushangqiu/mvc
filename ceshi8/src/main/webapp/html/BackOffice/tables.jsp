              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <div class="col">
                      <button type="button" id="addButton" class="mb-2 btn btn-sm btn-outline-primary ml-12">新增</button>
                    </div>
                  </div>
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-0">账户ID</th>
                          <th scope="col" class="border-0">账户名称</th>
                          <th scope="col" class="border-0">账户密码</th>
                      ...
                      <c:forEach items="${userList}" var="user" varStatus="status">
                        <tr>
                          ...
                          <td>${user.password}</td>
                          <td>
                            <a class="pp-cta extra-action" id="update" >修改</a>
                            <a class="pp-cta extra-action" id="delet" >删除</a>
                          </td>
                        </tr>
                      </c:forEach>
                      </tbody>
...
<script>
  $('#addButton').click(function(){
      location.href='/html/BackOffice/addUser.jsp';
  })
